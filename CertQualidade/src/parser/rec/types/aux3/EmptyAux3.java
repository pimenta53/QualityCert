...
public final class EmptyAux3 extends parser.rec.types.aux3.Aux3 implements tom.library.sl.Visitable  {
  
  private static String symbolName = "EmptyAux3";


  private EmptyAux3() {}
  private static int hashCode = hashFunction();
  private static EmptyAux3 gomProto = (EmptyAux3) factory.build(new EmptyAux3());
  
  /**
   * Constructor that builds a term rooted by EmptyAux3
   *
   * @return a term rooted by EmptyAux3
   */

  public static EmptyAux3 make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a EmptyAux3 and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof EmptyAux3) {
   ...
   *
   * @return true, because this is rooted by EmptyAux3
   */
  @Override
