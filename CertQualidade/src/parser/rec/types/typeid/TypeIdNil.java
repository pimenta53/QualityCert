...
public final class TypeIdNil extends parser.rec.types.TypeId implements tom.library.sl.Visitable  {
  
  private static String symbolName = "TypeIdNil";


  private TypeIdNil() {}
  private static int hashCode = hashFunction();
  private static TypeIdNil gomProto = (TypeIdNil) factory.build(new TypeIdNil());
  
  /**
   * Constructor that builds a term rooted by TypeIdNil
   *
   * @return a term rooted by TypeIdNil
   */

  public static TypeIdNil make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a TypeIdNil and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof TypeIdNil) {
   ...
   *
   * @return true, because this is rooted by TypeIdNil
   */
  @Override
