...
public final class TypeIdInteger extends parser.rec.types.TypeId implements tom.library.sl.Visitable  {
  
  private static String symbolName = "TypeIdInteger";


  private TypeIdInteger() {}
  private int hashCode;
  private static TypeIdInteger gomProto = new TypeIdInteger();
    private int _i;

  /**
   * Constructor that builds a term rooted by TypeIdInteger
   *
   * @return a term rooted by TypeIdInteger
   */

  public static TypeIdInteger make(int _i) {

    // use the proto as a model
    gomProto.initHashCode( _i);
    return (TypeIdInteger) factory.build(gomProto);
   ...
   *
   * @param  _i
   * @param hashCode hashCode of TypeIdInteger
   */
  ...
  public shared.SharedObject duplicate() {
    TypeIdInteger clone = new TypeIdInteger();
  ...
  public int compareToLPO(Object o) {
    ...
    /* compare the childs */
    TypeIdInteger tco = (TypeIdInteger) ao;
    if( this._i != tco._i) {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a TypeIdInteger and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof TypeIdInteger) {

      TypeIdInteger peer = (TypeIdInteger) obj;
   ...
   *
   * @return true, because this is rooted by TypeIdInteger
   */
  @Override
   ...
   */
  @Override
  public parser.rec.types.TypeId seti(int set_arg) {
    return make(set_arg);
  }
