...
public final class EmptyAux4 extends parser.rec.types.aux4.Aux4 implements tom.library.sl.Visitable  {
  
  private static String symbolName = "EmptyAux4";


  private EmptyAux4() {}
  private static int hashCode = hashFunction();
  private static EmptyAux4 gomProto = (EmptyAux4) factory.build(new EmptyAux4());
  
  /**
   * Constructor that builds a term rooted by EmptyAux4
   *
   * @return a term rooted by EmptyAux4
   */

  public static EmptyAux4 make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a EmptyAux4 and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof EmptyAux4) {
   ...
   *
   * @return true, because this is rooted by EmptyAux4
   */
  @Override
