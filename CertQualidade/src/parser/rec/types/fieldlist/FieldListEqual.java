...
public final class FieldListEqual extends parser.rec.types.FieldList implements tom.library.sl.Visitable  {
  
  private static String symbolName = "FieldListEqual";


  private FieldListEqual() {}
  private int hashCode;
  private static FieldListEqual gomProto = new FieldListEqual();
    private String _id;
  private parser.rec.types.TypeId _ti;
  private parser.rec.types.AuxFieldList _a;

  /**
   * Constructor that builds a term rooted by FieldListEqual
   *
   * @return a term rooted by FieldListEqual
   */

  public static FieldListEqual make(String _id, parser.rec.types.TypeId _ti, parser.rec.types.AuxFieldList _a) {

    // use the proto as a model
    gomProto.initHashCode( _id,  _ti,  _a);
    return (FieldListEqual) factory.build(gomProto);
   ...
   * @param _ti
   * @param _a
   * @param hashCode hashCode of FieldListEqual
   */
  private void init(String _id, parser.rec.types.TypeId _ti, parser.rec.types.AuxFieldList _a, int hashCode) {
    this._id = _id.intern();
    this._ti = _ti;
    this._a = _a;
   ...
   * @param _a
   */
  private void initHashCode(String _id, parser.rec.types.TypeId _ti, parser.rec.types.AuxFieldList _a) {
    this._id = _id.intern();
    this._ti = _ti;
    this._a = _a;
  ...
  public shared.SharedObject duplicate() {
    FieldListEqual clone = new FieldListEqual();
...
buffer.append(",");
  ...
  public int compareToLPO(Object o) {
    ...
    /* compare the childs */
    FieldListEqual tco = (FieldListEqual) ao;
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a FieldListEqual and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof FieldListEqual) {

      FieldListEqual peer = (FieldListEqual) obj;
   ...
   *
   * @return true, because this is rooted by FieldListEqual
   */
  @Override
   ...
   */
  @Override
  public parser.rec.types.FieldList setid(String set_arg) {
...
convertATermToString(appl.getArgument(0), atConv), parser.rec.types.TypeId.fromTerm(appl.getArgument(1),atConv), parser.rec.types.AuxFieldList.fromTerm(appl.getArgument(2),atConv)
  ...
  public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable v) {
    switch(index) {
      ...
      case 2: return make(getid(), _ti, (parser.rec.types.AuxFieldList) v);
