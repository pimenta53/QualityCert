...
public final class FNeg extends parser.rec.types.Factor implements tom.library.sl.Visitable  {
  
  private static String symbolName = "FNeg";


  private FNeg() {}
  private int hashCode;
  private static FNeg gomProto = new FNeg();
    private parser.rec.types.Exp _e1;

  /**
   * Constructor that builds a term rooted by FNeg
   *
   * @return a term rooted by FNeg
   */

  public static FNeg make(parser.rec.types.Exp _e1) {

    // use the proto as a model
    gomProto.initHashCode( _e1);
    return (FNeg) factory.build(gomProto);
   ...
   *
   * @param  _e1
   * @param hashCode hashCode of FNeg
   */
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a FNeg and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof FNeg) {
   ...
   *
   * @return true, because this is rooted by FNeg
   */
  @Override
