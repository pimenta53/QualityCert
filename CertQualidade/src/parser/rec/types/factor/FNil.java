...
public final class FNil extends parser.rec.types.Factor implements tom.library.sl.Visitable  {
  
  private static String symbolName = "FNil";


  private FNil() {}
  private static int hashCode = hashFunction();
  private static FNil gomProto = (FNil) factory.build(new FNil());
  
  /**
   * Constructor that builds a term rooted by FNil
   *
   * @return a term rooted by FNil
   */

  public static FNil make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a FNil and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof FNil) {
   ...
   *
   * @return true, because this is rooted by FNil
   */
  @Override
