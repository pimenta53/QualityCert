...
public final class FBreak extends parser.rec.types.Factor implements tom.library.sl.Visitable  {
  
  private static String symbolName = "FBreak";


  private FBreak() {}
  private static int hashCode = hashFunction();
  private static FBreak gomProto = (FBreak) factory.build(new FBreak());
  
  /**
   * Constructor that builds a term rooted by FBreak
   *
   * @return a term rooted by FBreak
   */

  public static FBreak make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a FBreak and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof FBreak) {
   ...
   *
   * @return true, because this is rooted by FBreak
   */
  @Override
