...
public final class FInteger extends parser.rec.types.Factor implements tom.library.sl.Visitable  {
  
  private static String symbolName = "FInteger";


  private FInteger() {}
  private int hashCode;
  private static FInteger gomProto = new FInteger();
    private int _i;

  /**
   * Constructor that builds a term rooted by FInteger
   *
   * @return a term rooted by FInteger
   */

  public static FInteger make(int _i) {

    // use the proto as a model
    gomProto.initHashCode( _i);
    return (FInteger) factory.build(gomProto);
   ...
   *
   * @param  _i
   * @param hashCode hashCode of FInteger
   */
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a FInteger and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof FInteger) {

      FInteger peer = (FInteger) obj;
   ...
   *
   * @return true, because this is rooted by FInteger
   */
  @Override
   ...
   */
  @Override
  public parser.rec.types.Factor seti(int set_arg) {
    return make(set_arg);
  }
