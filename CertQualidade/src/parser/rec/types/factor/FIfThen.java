...
public final class FIfThen extends parser.rec.types.Factor implements tom.library.sl.Visitable  {
  
  private static String symbolName = "FIfThen";


  private FIfThen() {}
  private int hashCode;
  private static FIfThen gomProto = new FIfThen();
    private parser.rec.types.Exp _e1;
  private parser.rec.types.Exp _e2;

  /**
   * Constructor that builds a term rooted by FIfThen
   *
   * @return a term rooted by FIfThen
   */

  public static FIfThen make(parser.rec.types.Exp _e1, parser.rec.types.Exp _e2) {

    // use the proto as a model
    gomProto.initHashCode( _e1,  _e2);
    return (FIfThen) factory.build(gomProto);
   ...
   * @param  _e1
   * @param _e2
   * @param hashCode hashCode of FIfThen
   */
...
buffer.append(",");
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a FIfThen and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof FIfThen) {

      FIfThen peer = (FIfThen) obj;
   ...
   *
   * @return true, because this is rooted by FIfThen
   */
  @Override
