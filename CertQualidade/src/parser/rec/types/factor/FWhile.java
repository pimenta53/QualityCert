...
public final class FWhile extends parser.rec.types.Factor implements tom.library.sl.Visitable  {
  
  private static String symbolName = "FWhile";


  private FWhile() {}
  private int hashCode;
  private static FWhile gomProto = new FWhile();
    private parser.rec.types.Exp _e1;
  private parser.rec.types.Exp _e2;

  /**
   * Constructor that builds a term rooted by FWhile
   *
   * @return a term rooted by FWhile
   */

  public static FWhile make(parser.rec.types.Exp _e1, parser.rec.types.Exp _e2) {

    // use the proto as a model
    gomProto.initHashCode( _e1,  _e2);
    return (FWhile) factory.build(gomProto);
   ...
   * @param  _e1
   * @param _e2
   * @param hashCode hashCode of FWhile
   */
...
buffer.append(",");
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a FWhile and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof FWhile) {

      FWhile peer = (FWhile) obj;
   ...
   *
   * @return true, because this is rooted by FWhile
   */
  @Override
