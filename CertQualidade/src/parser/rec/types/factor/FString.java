...
public final class FString extends parser.rec.types.Factor implements tom.library.sl.Visitable  {
  
  private static String symbolName = "FString";


  private FString() {}
  private int hashCode;
  private static FString gomProto = new FString();
    private String _s;

  /**
   * Constructor that builds a term rooted by FString
   *
   * @return a term rooted by FString
   */

  public static FString make(String _s) {

    // use the proto as a model
    gomProto.initHashCode( _s);
    return (FString) factory.build(gomProto);
   ...
   *
   * @param  _s
   * @param hashCode hashCode of FString
   */
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a FString and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof FString) {

      FString peer = (FString) obj;
   ...
   *
   * @return true, because this is rooted by FString
   */
  @Override
   ...
   */
  @Override
  public parser.rec.types.Factor sets(String set_arg) {
    return make(set_arg);
  }
