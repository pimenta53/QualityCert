...
package parser.rec.types.expandpr;



public final class ExpANDPr extends parser.rec.types.ExpANDPr implements tom.library.sl.Visitable  {
  
  private static String symbolName = "ExpANDPr";


  private ExpANDPr() {}
  private int hashCode;
  private static ExpANDPr gomProto = new ExpANDPr();
   ...
   *
   * @param  _e1
   * @param hashCode hashCode of ExpANDPr
   */
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a ExpANDPr and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof ExpANDPr) {

      ExpANDPr peer = (ExpANDPr) obj;
   ...
   *
   * @return true, because this is rooted by ExpANDPr
   */
  @Override
  ...
  /**
   * Sets and returns the attribute parser.rec.types.ExpANDPr
   *
   * @param set_arg the argument to set
   * @return the attribute parser.rec.types.Exp which just has been set
   */
  @Override
  public parser.rec.types.ExpANDPr sete1(parser.rec.types.Exp set_arg) {
    return make(set_arg);
  }
