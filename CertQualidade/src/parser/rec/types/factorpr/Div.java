...
public final class Div extends parser.rec.types.FactorPr implements tom.library.sl.Visitable  {
  ...
  private static Div gomProto = new Div();
  ...
  public static Div make(parser.rec.types.Factor _f, parser.rec.types.FactorPr _fp) {

    // use the proto as a model
    gomProto.initHashCode( _f,  _fp);
    return (Div) factory.build(gomProto);
   ...
   * @param  _f
   * @param _fp
   * @param hashCode hashCode of Div
   */
