...
package parser.rec.types.factorpr;



public final class Times extends parser.rec.types.FactorPr implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Times";


  private Times() {}
  private int hashCode;
  private static Times gomProto = new Times();
    private parser.rec.types.Factor _f;
  private parser.rec.types.FactorPr _fp;

  /**
   * Constructor that builds a term rooted by Times
   *
   * @return a term rooted by Times
   */

  public static Times make(parser.rec.types.Factor _f, parser.rec.types.FactorPr _fp) {

    // use the proto as a model
    gomProto.initHashCode( _f,  _fp);
    return (Times) factory.build(gomProto);
   ...
   * @param  _f
   * @param _fp
   * @param hashCode hashCode of Times
   */
...
buffer.append(",");
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Times and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof Times) {

      Times peer = (Times) obj;
   ...
   *
   * @return true, because this is rooted by Times
   */
  @Override
  ...
  /**
   * Sets and returns the attribute parser.rec.types.FactorPr
   *
   * @param set_arg the argument to set
   * @return the attribute parser.rec.types.Factor which just has been set
   */
  @Override
  public parser.rec.types.FactorPr setf(parser.rec.types.Factor set_arg) {
   ...
   */
  @Override
  public parser.rec.types.FactorPr setfp(parser.rec.types.FactorPr set_arg) {
