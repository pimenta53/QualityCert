...
public final class FRA1 extends parser.rec.types.FunctionRecordArray implements tom.library.sl.Visitable  {
  
  private static String symbolName = "FRA1";


  private FRA1() {}
  private int hashCode;
  private static FRA1 gomProto = new FRA1();
    private parser.rec.types.AuxFRA1 _a1;

  /**
   * Constructor that builds a term rooted by FRA1
   *
   * @return a term rooted by FRA1
   */

  public static FRA1 make(parser.rec.types.AuxFRA1 _a1) {

    // use the proto as a model
    gomProto.initHashCode( _a1);
    return (FRA1) factory.build(gomProto);
   ...
   *
   * @param  _a1
   * @param hashCode hashCode of FRA1
   */
  private void init(parser.rec.types.AuxFRA1 _a1, int hashCode) {
    this._a1 = _a1;
   ...
   * @param  _a1
   */
  private void initHashCode(parser.rec.types.AuxFRA1 _a1) {
    this._a1 = _a1;
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a FRA1 and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof FRA1) {
   ...
   *
   * @return true, because this is rooted by FRA1
   */
  @Override
  ...
  public static parser.rec.types.FunctionRecordArray fromTerm(aterm.ATerm trm, tom.library.utils.ATermConverter atConv) {
    ...
    if(trm instanceof aterm.ATermAppl) {
      ...
      if(symbolName.equals(appl.getName()) && !appl.getAFun().isQuoted()) {
        return make(
parser.rec.types.AuxFRA1.fromTerm(appl.getArgument(0),atConv)
        );
      }
    }
    return null;
  ...
  public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable v) {
    switch(index) {
      case 0: return make((parser.rec.types.AuxFRA1) v);
  ...
  public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] childs) {
    if (childs.length == 1  && childs[0] instanceof parser.rec.types.AuxFRA1) {
      return make((parser.rec.types.AuxFRA1) childs[0]);
    } else {
