...
public final class VarDec1 extends parser.rec.types.VarDec implements tom.library.sl.Visitable  {
  
  private static String symbolName = "VarDec1";


  private VarDec1() {}
  private int hashCode;
  private static VarDec1 gomProto = new VarDec1();
    private String _id;
  private parser.rec.types.Aux2 _a;

  /**
   * Constructor that builds a term rooted by VarDec1
   *
   * @return a term rooted by VarDec1
   */

  public static VarDec1 make(String _id, parser.rec.types.Aux2 _a) {

    // use the proto as a model
    gomProto.initHashCode( _id,  _a);
    return (VarDec1) factory.build(gomProto);
   ...
   * @param  _id
   * @param _a
   * @param hashCode hashCode of VarDec1
   */
  private void init(String _id, parser.rec.types.Aux2 _a, int hashCode) {
    this._id = _id.intern();
    this._a = _a;
   ...
   * @param _a
   */
  private void initHashCode(String _id, parser.rec.types.Aux2 _a) {
    this._id = _id.intern();
    this._a = _a;
...
buffer.append(",");
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a VarDec1 and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof VarDec1) {

      VarDec1 peer = (VarDec1) obj;
   ...
   *
   * @return true, because this is rooted by VarDec1
   */
  @Override
  ...
  public static parser.rec.types.VarDec fromTerm(aterm.ATerm trm, tom.library.utils.ATermConverter atConv) {
    ...
    if(trm instanceof aterm.ATermAppl) {
      ...
      if(symbolName.equals(appl.getName()) && !appl.getAFun().isQuoted()) {
        return make(
convertATermToString(appl.getArgument(0), atConv), parser.rec.types.Aux2.fromTerm(appl.getArgument(1),atConv)
        );
      }
    }
    return null;
  ...
  public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable v) {
    switch(index) {
      ...
      case 1: return make(getid(), (parser.rec.types.Aux2) v);
  ...
  public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] childs) {
    if (childs.length == 2  && childs[0] instanceof tom.library.sl.VisitableBuiltin && childs[1] instanceof parser.rec.types.Aux2) {
      return make(((tom.library.sl.VisitableBuiltin<String>)childs[0]).getBuiltin(), (parser.rec.types.Aux2) childs[1]);
    } else {
