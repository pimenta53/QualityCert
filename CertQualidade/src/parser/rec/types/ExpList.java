...
public abstract class ExpList extends parser.rec.RecAbstractType  {
  /**
   ...
   *
   * @return true if the term is rooted by the symbol ExpList
   */
  ...
  /**
   * Returns true if the term is rooted by the symbol ExpListEmpty
   *
   * @return true if the term is rooted by the symbol ExpListEmpty
   */
  public boolean isExpListEmpty() {
    return false;
  }
  ...
  public parser.rec.types.Exp gete1() {
    throw new UnsupportedOperationException("This ExpList has no e1");
  }
   ...
   */
  public ExpList sete1(parser.rec.types.Exp _arg) {
    throw new UnsupportedOperationException("This ExpList has no e1");
  }
  ...
  public parser.rec.types.AuxExpList geta() {
    throw new UnsupportedOperationException("This ExpList has no a");
  }
   ...
   */
  public ExpList seta(parser.rec.types.AuxExpList _arg) {
    throw new UnsupportedOperationException("This ExpList has no a");
  }
   ...
   */
  public static parser.rec.types.ExpList fromTerm(aterm.ATerm trm) {
   ...
   */
  public static parser.rec.types.ExpList fromString(String s) {
   ...
   */
  public static parser.rec.types.ExpList fromStream(java.io.InputStream stream) throws java.io.IOException {
  ...
  public static parser.rec.types.ExpList fromTerm(aterm.ATerm trm, tom.library.utils.ATermConverter atConv) {
    ...
    parser.rec.types.ExpList tmp;
    java.util.ArrayList<parser.rec.types.ExpList> results = new java.util.ArrayList<parser.rec.types.ExpList>();

    tmp = parser.rec.types.explist.ExpList.fromTerm(convertedTerm,atConv);
    if(tmp!=null) {
      results.add(tmp);
    }
    tmp = parser.rec.types.explist.ExpListEmpty.fromTerm(convertedTerm,atConv);
    if(tmp!=null) {
      results.add(tmp);
    }
    switch(results.size()) {
   ...
   * @return the Gom term
   */
  public static parser.rec.types.ExpList fromString(String s, tom.library.utils.ATermConverter atConv) {
   ...
   * @return the Gom term
   */
  public static parser.rec.types.ExpList fromStream(java.io.InputStream stream, tom.library.utils.ATermConverter atConv) throws java.io.IOException {
   ...
   * @throws IllegalArgumentException if the term is not a list
   */
  public parser.rec.types.ExpList reverse() {
    throw new IllegalArgumentException(
      "This "+this.getClass().getName()+" is not a list");
  }
