...
package parser.rec.types.prog;



public final class Prog extends parser.rec.types.Prog implements tom.library.sl.Visitable  {
  ...
  public static Prog make(parser.rec.types.Exp _e1) {
 ...
 //shared.SharedObject
  ...
  /**
   * Sets and returns the attribute parser.rec.types.Prog
   *
   * @param set_arg the argument to set
   * @return the attribute parser.rec.types.Exp which just has been set
   */
  @Override
  public parser.rec.types.Prog sete1(parser.rec.types.Exp set_arg) {
    return make(set_arg);
  }
