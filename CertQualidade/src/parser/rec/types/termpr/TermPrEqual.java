...
package parser.rec.types.termpr;



public final class TermPrEqual extends parser.rec.types.TermPr implements tom.library.sl.Visitable  {
  
  private static String symbolName = "TermPrEqual";


  private TermPrEqual() {}
  private int hashCode;
  private static TermPrEqual gomProto = new TermPrEqual();
    private parser.rec.types.Term _t;
  private parser.rec.types.TermPr _tp;

  /**
   * Constructor that builds a term rooted by TermPrEqual
   *
   * @return a term rooted by TermPrEqual
   */

  public static TermPrEqual make(parser.rec.types.Term _t, parser.rec.types.TermPr _tp) {

    // use the proto as a model
    gomProto.initHashCode( _t,  _tp);
    return (TermPrEqual) factory.build(gomProto);
   ...
   * @param  _t
   * @param _tp
   * @param hashCode hashCode of TermPrEqual
   */
  ...
  public shared.SharedObject duplicate() {
    TermPrEqual clone = new TermPrEqual();
...
buffer.append(",");
  ...
  public int compareToLPO(Object o) {
    ...
    /* compare the childs */
    TermPrEqual tco = (TermPrEqual) ao;
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a TermPrEqual and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof TermPrEqual) {

      TermPrEqual peer = (TermPrEqual) obj;
   ...
   *
   * @return true, because this is rooted by TermPrEqual
   */
  @Override
  ...
  /**
   * Sets and returns the attribute parser.rec.types.TermPr
   *
   * @param set_arg the argument to set
   * @return the attribute parser.rec.types.Term which just has been set
   */
  @Override
  public parser.rec.types.TermPr sett(parser.rec.types.Term set_arg) {
   ...
   */
  @Override
  public parser.rec.types.TermPr settp(parser.rec.types.TermPr set_arg) {
