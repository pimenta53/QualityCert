...
public final class TermPrNeg extends parser.rec.types.TermPr implements tom.library.sl.Visitable  {
  
  private static String symbolName = "TermPrNeg";


  private TermPrNeg() {}
  private int hashCode;
  private static TermPrNeg gomProto = new TermPrNeg();
    private parser.rec.types.Term _t;
  private parser.rec.types.TermPr _tp;

  /**
   * Constructor that builds a term rooted by TermPrNeg
   *
   * @return a term rooted by TermPrNeg
   */

  public static TermPrNeg make(parser.rec.types.Term _t, parser.rec.types.TermPr _tp) {

    // use the proto as a model
    gomProto.initHashCode( _t,  _tp);
    return (TermPrNeg) factory.build(gomProto);
   ...
   * @param  _t
   * @param _tp
   * @param hashCode hashCode of TermPrNeg
   */
...
buffer.append(",");
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a TermPrNeg and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof TermPrNeg) {

      TermPrNeg peer = (TermPrNeg) obj;
   ...
   *
   * @return true, because this is rooted by TermPrNeg
   */
  @Override
