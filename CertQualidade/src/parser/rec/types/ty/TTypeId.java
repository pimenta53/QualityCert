...
public final class TTypeId extends parser.rec.types.Ty implements tom.library.sl.Visitable  {
  
  private static String symbolName = "TTypeId";


  private TTypeId() {}
  private int hashCode;
  private static TTypeId gomProto = new TTypeId();
    private parser.rec.types.TypeId _ti;

  /**
   * Constructor that builds a term rooted by TTypeId
   *
   * @return a term rooted by TTypeId
   */

  public static TTypeId make(parser.rec.types.TypeId _ti) {

    // use the proto as a model
    gomProto.initHashCode( _ti);
    return (TTypeId) factory.build(gomProto);
   ...
   *
   * @param  _ti
   * @param hashCode hashCode of TTypeId
   */
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a TTypeId and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof TTypeId) {

      TTypeId peer = (TTypeId) obj;
   ...
   *
   * @return true, because this is rooted by TTypeId
   */
  @Override
