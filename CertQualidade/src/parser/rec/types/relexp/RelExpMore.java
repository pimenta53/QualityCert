...
public final class RelExpMore extends parser.rec.types.RelExp implements tom.library.sl.Visitable  {
  
  private static String symbolName = "RelExpMore";


  private RelExpMore() {}
  private int hashCode;
  private static RelExpMore gomProto = new RelExpMore();
    private parser.rec.types.AritExp _a2;

  /**
   * Constructor that builds a term rooted by RelExpMore
   *
   * @return a term rooted by RelExpMore
   */

  public static RelExpMore make(parser.rec.types.AritExp _a2) {

    // use the proto as a model
    gomProto.initHashCode( _a2);
    return (RelExpMore) factory.build(gomProto);
   ...
   *
   * @param  _a2
   * @param hashCode hashCode of RelExpMore
   */
  private void init(parser.rec.types.AritExp _a2, int hashCode) {
    this._a2 = _a2;
   ...
   * @param  _a2
   */
  private void initHashCode(parser.rec.types.AritExp _a2) {
    this._a2 = _a2;
  ...
  public shared.SharedObject duplicate() {
    RelExpMore clone = new RelExpMore();
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a RelExpMore and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof RelExpMore) {

      RelExpMore peer = (RelExpMore) obj;
   ...
   *
   * @return true, because this is rooted by RelExpMore
   */
  @Override
   ...
   */
  @Override
  public parser.rec.types.RelExp seta2(parser.rec.types.AritExp set_arg) {
    return make(set_arg);
  }
